...
Upon running the certutil command I saw that the file hash that I received was the same as that posted on the offical website, so I proceeded with installation.
